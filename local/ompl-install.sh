...
cp ../docker/config/panda_demo.rviz ~/catkin_ws/config/panda_demo.rviz
cp ../docker/config/pillar.scene ~/catkin_ws/config/pillar.scene
cp ../docker/config/package.xml ~/catkin_ws/src/ompl/package.xml
